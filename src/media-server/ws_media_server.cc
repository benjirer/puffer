...
{
  cerr << program_name << " <YAML configuration> <server ID> [<expt ID>]"
       << endl;
}
...
/* return "ip:port" for the client */
string client_address_with_port(const WebSocketClient &client)
{
  return client.address().ip() + ":" + to_string(client.address().port());
}
                           ...
                           WebSocketClient &client)
{
  ...
  if (enable_logging)
  {
    string log_line = to_string(timestamp_ms()) + "," + channel->name() + "," + server_id + "," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(client.init_id().value()) + "," + to_string(next_vts) + "," + next_vformat.to_string() + "," + to_string(get<1>(data_mmap)) + "," + to_string(ssim) + "," + to_string(tcpi.cwnd) + "," + to_string(tcpi.in_flight) + "," + to_string(tcpi.min_rtt) + "," + to_string(tcpi.rtt) + "," + to_string(tcpi.delivery_rate) + "," + double_to_string(client.video_playback_buf(), 3) + "," + double_to_string(client.cum_rebuffer(), 3);
...
void serve_client(WebSocketServer &server, WebSocketClient &client)
{
  ...
  if (client.audio_playback_buf() <= WebSocketClient::MAX_BUFFER_S and
      client.audio_in_flight().value() == 0 and channel->aready_to_serve(next_ats) and next_ats <= next_vts)
  {
...
void log_active_streams(const uint64_t this_minute)
{
  ...
  {
    string log_line = to_string(this_minute) + "," + channel_name + "," + server_id + "," + expt_id + "," + to_string(count);
                        ...
                        const ClientInitMsg &msg)
{
  ...
  if (enable_logging)
  {
    string log_line = to_string(timestamp_ms()) + "," + msg.channel + "," + server_id + ",init," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(msg.init_id) + ",0,0" /* buffer cum_rebuf */;
    append_to_log("client_buffer", log_line);

    /* record system information */
    log_line = to_string(timestamp_ms()) + "," + server_id + "," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(msg.init_id) + "," + client_address_with_port(client) + "," // Include IP and port
               + client.os() + "," + client.browser() + "," + to_string(client.screen_width()) + "," + to_string(client.screen_height());
...
void handle_client_info(WebSocketClient &client, const ClientInfoMsg &msg)
{
  ...
  if (msg.screen_width and msg.screen_height)
  {
    ...
    if (enable_logging)
    {
      string log_line = to_string(timestamp_ms()) + "," + server_id + "," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(msg.init_id) + "," + client_address_with_port(client) + "," // Include IP and port
                        + client.os() + "," + client.browser() + "," + to_string(*msg.screen_width) + "," + to_string(*msg.screen_height);
      append_to_log("client_sysinfo", log_line);
    }
  }
  ...
  if (enable_logging)
  {
    ...
    /* record client-info */
    string log_line = to_string(timestamp_ms()) + "," + channel_name + "," + server_id + "," + msg.event_str + "," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(msg.init_id) + "," + double_to_string(msg.video_buffer, 3) + "," + double_to_string(msg.cum_rebuffer, 3);
    append_to_log("client_buffer", log_line);
  }
}
                             ...
                             const ClientVidAckMsg &msg)
{
  ...
  if (enable_logging)
  {
    string log_line = to_string(timestamp_ms()) + "," + msg.channel + "," + server_id + "," + expt_id + "," + client.username() + "," + to_string(client.first_init_id().value()) + "," + to_string(msg.init_id) + "," + to_string(msg.timestamp) + "," + to_string(msg.ssim) + "," + double_to_string(msg.video_buffer, 3) + "," + double_to_string(msg.cum_rebuffer(), 3);
